...
export const aboutData = {
  ...
  paragraphThree: "Here are a few of the technologies I've been learning/using recently: Unity, C#, React, GraphQL, Gatsby, JavaScript, Babel, Webpack, Sass/CSS, Git, Netlify, WebGL, SQL ",
...
export const projectsData = [
  ...
  },
  {
    ...
    img: 'dicegame.webp',
    title: 'Dice Game',
    info: 'I Built this as part of a Udemy Complete JavaScript course. It\'s a simple dice game for two players, first one to the pre-set total wins.',
    info2:
  ...
  },
  {
    ...
    title: 'Budget App',
    info: 'A simple monthly budget calculator/tracker app. Built as an exercise in JavaScript fundamentals.',
    info2:
      'Built as part of a Udemy complete Javascript course.',
    info3: "HTML, CSS, JS",
  ...
  },
  {
    ...
    info2:
      'This is one of my very first ever web pages!',
    info3: "HTML, CSS",
  ...
  },
  {
    ...
    info: 'Built this with two others for Global Game Jam 2020. It\'s a house manager sim, where you have to fix up an old house and manage your tenants\' happiness.',
    info2:
      'A work in progress...',
    info3: "Unity, C#, WebGL",
  ...
  },
  {
    ...
    info2:
      'It\'s a voice-controlled golf game where you have to yell at the ball to make it move.',
    info3: "Unity, C#",
